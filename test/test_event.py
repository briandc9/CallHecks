...
"""Test Event object implemented in scheduling.py."""
import unittest
import datetime
...
class TestEvent(unittest.TestCase):
    ...
    def test_register(self):
        rager = scheduling.Event("Nathan Trinkl's Birthday Bash",
                                 datetime.datetime(18, 3, 16, 9, 55))
        anant = users.Performer("Anant Sahai", 94704, "I reenact animes.")
    ...
    def test_performer(self):
        rager = scheduling.Event("Nathan Trinkl's Birthday Bash",
                                 datetime.datetime(18, 3, 16, 9, 55))
        performer1 = users.Performer("Anant Sahai", 94704, "I reenact animes.")
        performer2 = users.Performer("Anant Sabai", 94704, "I reenact fiestas.")
        performer3 = users.Performer("Anant Sagai", 94704, "I reenact movies.")
    ...
    def test_end_time(self):
        party = scheduling.Event("Balaji's Birthday Siesta",
                                 datetime.datetime(18, 5, 14, 6, 15), 30)
        self.assertEqual(party.end_time, datetime.datetime(18, 5, 14, 6, 45))

    def test_eq(self):
        rager1 = scheduling.Event("Nathan Trinkl's Birthday Bash",
                                  datetime.datetime(18, 3, 16, 9, 55))
        rager2 = scheduling.Event("Nathan Trinkl's Birthday Bash",
                                  datetime.datetime(18, 3, 16, 9, 55))
